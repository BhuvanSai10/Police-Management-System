...
public class GiveFeedback extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        feedbacktext.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(idtext, javax.swing.GroupLayout.PREFERRED_SIZE, 236, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(idtext.getText().equals("") || feedbacktext.getText().equals("")){
            ...
            try {
                ...
                String sql = "select * from userfeedback where id=?";
                ...
                if(rs.next()){
                    ...
                    pst = con.prepareStatement("insert into userfeedback values(?,?)");
                    pst.setInt(1, Integer.parseInt(idtext.getText()));
                    pst.setString(2,feedbacktext.getText());      
